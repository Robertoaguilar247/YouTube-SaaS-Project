...
Make every task and code change you do as simple as possible. We want to avoid making any massive or complex changes. Every change
8. **Process Documentation**
Every time you perform actions related to the project, append your actions to docs/activity.md and read that file whenever you fin
9. **Git Repository**
...
11. **ID tags**
In every html file make sure each div tag has a unique id that I can use to communicate with you through my prompts when I need to
12. **Review Process**
